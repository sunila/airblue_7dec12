...
--  \   \         Application: netgen
--  /   /         Filename: icon.vhd
-- /___/   /\     Timestamp: Sat Mar 12 13:39:21 2011
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -w -sim -ofmt vhdl /afs/csail.mit.edu/u/m/mcn02/airblue2_hw_sw/uhd/fpga/usrp2/coregen/chipscope/tmp/_cg/icon.ngc /afs/csail.mit.edu/u/m/mcn02/airblue2_hw_sw/uhd/fpga/usrp2/coregen/chipscope/tmp/_cg/icon.vhd 
-- Device	: xc3s2000-fg456-5
-- Input file	: /afs/csail.mit.edu/u/m/mcn02/airblue2_hw_sw/uhd/fpga/usrp2/coregen/chipscope/tmp/_cg/icon.ngc
-- Output file	: /afs/csail.mit.edu/u/m/mcn02/airblue2_hw_sw/uhd/fpga/usrp2/coregen/chipscope/tmp/_cg/icon.vhd
-- # of Entities	: 1
-- Design Name	: icon
-- Xilinx	: /afs/csail.mit.edu/group/csg/tools/tools_lx86/xilinx/12.1/ISE_DS/ISE/
--             
-- Purpose:    
...
architecture STRUCTURE of icon is
  ...
  signal N1 : STD_LOGIC; 
  signal NlwRenamedSig_OI_TDI_OUT : STD_LOGIC; 
  signal U0_U_ICON_I_YES_BSCAN_U_BS_DRCK2 : STD_LOGIC; 
  ...
  signal U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O_3_97 : STD_LOGIC; 
  signal U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O_4_98 : STD_LOGIC; 
  ...
  signal NlwRenamedSig_OI_U0_iSHIFT_OUT : STD_LOGIC; 
  signal NlwRenamedSig_OI_U0_iUPDATE_OUT : STD_LOGIC; 
...
begin
  TDI_OUT <= NlwRenamedSig_OI_TDI_OUT;
  UPDATE_OUT <= NlwRenamedSig_OI_U0_iUPDATE_OUT;
  SHIFT_OUT <= NlwRenamedSig_OI_U0_iSHIFT_OUT;
  XST_GND : GND
    port map (
      G => CONTROL0(2)
    );
  ...
  U0_U_ICON_U_iDATA_CMD : FDC
    ...
    port map (
      C => NlwRenamedSig_OI_U0_iUPDATE_OUT,
  ...
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O_2_f5 : MUXF5
    port map (
      I0 => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O_4_98,
      I1 => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O_3_97,
  ...
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O_4 : LUT4
    ...
    port map (
      ...
      O => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O_4_98
    );
  U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O_3 : LUT4
    ...
    port map (
      ...
      I2 => U0_U_ICON_iCORE_ID(1),
      I3 => U0_U_ICON_iCORE_ID(2),
      O => U0_U_ICON_U_TDO_MUX_U_CS_MUX_I4_U_MUX16_Mmux_O_3_97
    );
  ...
  U0_U_ICON_I_YES_BSCAN_U_BS_I_SPARTAN3_ISYN_I_USE_SOFTBSCAN_EQ0_I_3_U_BS : BSCAN_SPARTAN3
    port map (
      TDI => NlwRenamedSig_OI_TDI_OUT,
      SHIFT => NlwRenamedSig_OI_U0_iSHIFT_OUT,
      DRCK1 => DRCK_OUT,
      DRCK2 => U0_U_ICON_I_YES_BSCAN_U_BS_DRCK2,
      RESET => RESET_OUT,
      UPDATE => NlwRenamedSig_OI_U0_iUPDATE_OUT,
      TDO1 => TDO_IN,
      TDO2 => U0_U_ICON_iTDO,
      CAPTURE => CAPTURE_OUT,
      SEL1 => SEL_OUT,
  ...
  U0_U_ICON_I_YES_BSCAN_U_BS_I_USE_SOFTBSCAN_EQ0_I_USE_XST_TCK_WORKAROUND_EQ1_U_ICON_BSCAN_BUFG : icon_bscan_bufg
    port map (
      DRCK_LOCAL_I => U0_U_ICON_I_YES_BSCAN_U_BS_DRCK2,
  ...
  U0_U_ICON_U_CTRL_OUT_U_DATA_VALID : LUT2
    ...
    port map (
      I0 => U0_U_ICON_iSYNC,
      I1 => NlwRenamedSig_OI_U0_iSHIFT_OUT,
