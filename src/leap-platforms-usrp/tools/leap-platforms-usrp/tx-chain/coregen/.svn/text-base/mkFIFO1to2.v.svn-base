...
//
// On Wed Mar  2 16:29:28 EST 2011
//
...
module mkFIFO1to2(CLK,
  ...
  assign m_msb$EN = m_infifo$EMPTY_N && !m_popReady ;

  // register m_popReady
  assign m_popReady$D_IN = 1'd1 ;
  assign m_popReady$EN = m_infifo$EMPTY_N && !m_popReady ;

  // submodule m_infifo
  assign m_infifo$D_IN = enq_bits ;
  assign m_infifo$ENQ = EN_enq ;
  assign m_infifo$DEQ = m_infifo$EMPTY_N && !m_popReady || EN_pop ;
